  ...
  <table class="tbl">
    ...
    <tbody>
      <?php foreach ($by_status as $s): ?>
        <tr><td><?= h($s['status_name_th']) ?></td><td><?= (int)$s['n'] ?></td></tr>
      <?php endforeach; ?>
    </tbody>
  </table>
</div>
...
<div class="grid-2">
  <div class="card card-table">
    ...
    <?php else: ?>
      <table class="tbl">
        <thead><tr><th>บริษัท</th><th>จำนวน</th></tr></thead>
        <tbody>
        <?php foreach ($by_company as $c): ?>
          <tr><td><?= h($c['company_name']) ?></td><td><?= (int)$c['n'] ?></td></tr>
        <?php endforeach; ?>
        </tbody>
      </table>
    <?php endif; ?>
  ...
  <div class="card card-table">
    ...
    <?php else: ?>
      <table class="tbl">
        <thead><tr><th>อาจารย์</th><th>จำนวน</th></tr></thead>
        <tbody>
