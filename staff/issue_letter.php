...
<div class="card card-table">
    <div class="card-header">
        <h2>
          <i class="fas fa-inbox me-2" style="margin-right: 10px;"></i>คำขอที่พร้อมออกใบส่งตัว
        </h2>
    </div>
<?php if (!$ready): ?>
    ...
    <table class="tbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <a href="?id=<?= (int)$r['request_id'] ?>">ดู</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
...
<div class="card card-form">
    <div class="card-header">
        <h2>
          <i class="fas fa-file-invoice me-2" style="margin-right: 10px;"></i>ใบส่งตัว (Preview)
            #<?= (int)$preview['request_id'] ?>
          </h2>
    ...
    <form method="POST" class="form">
        ...
        <div class="actions">
            <button class="btn btn-primary" type="submit"><i class="fas fa-check me-1"></i>
                ยืนยันการออกใบส่งตัว</button>
